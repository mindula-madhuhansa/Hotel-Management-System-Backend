...
export interface ApiReservationReservation extends Schema.CollectionType {
  ...
  attributes: {
    InDate: Attribute.DateTime &
      Attribute.Required &
      Attribute.DefaultTo<'2023-11-02T18:30:00.000Z'>;
    OutDate: Attribute.DateTime &
      Attribute.Required &
      Attribute.DefaultTo<'2023-11-02T18:30:00.000Z'>;
    RoomTypes: Attribute.Relation<
      'api::reservation.reservation',
      'oneToMany',
      'api::room-type.room-type'
    >;
    RoomNumbers: Attribute.Relation<
      'api::reservation.reservation',
      'oneToMany',
      'api::room.room'
    >;
    RoomCount: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }> &
...
export interface ApiRoomRoom extends Schema.CollectionType {
  ...
  attributes: {
    RoomNumber: Attribute.String & Attribute.Required & Attribute.Unique;
    RoomType: Attribute.Relation<
      'api::room.room',
      'oneToOne',
      'api::room-type.room-type'
    >;
...
export interface ApiRoomTypeRoomType extends Schema.CollectionType {
  ...
  attributes: {
    RoomTypeName: Attribute.String & Attribute.Required & Attribute.Unique;
    MaxGuestCapacity: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }> &
      Attribute.DefaultTo<1>;
    RatePerNight: Attribute.Decimal &
      Attribute.SetMinMax<{
        min: 4.99;
      }>;
    reservation: Attribute.Relation<
      ...
      'api::reservation.reservation'
    >;
    AC: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
